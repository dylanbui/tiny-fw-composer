...
class Cookie
{
    ...
    {
        $this->make($name, $value, $expire, $path, $domain, $secure, $httpOnly, $raw);
    }

    public function make($name, $value = null, $expire = 0, $path = '/', $domain = null, $secure = false, $httpOnly = true, $raw = false)
    {
    ...
    public function __call($method, $arguments)
    {
        if($method == 'set') {
            if(count($arguments) == 1) {
                ...
                return call_user_func_array(array($this,'setCookiePrams'), $arguments);
            }
        }
    }
